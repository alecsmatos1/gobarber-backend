...
- O prestador deve poder vizualiar as notificações não lidas;
**RNF**
...
**RF**
- O usuário deve listar todos prestadores cadastrados;
...
- Os agendamentos devem estar disponíveis entre 8h às 18h (Promeiro às 8h, último às 17h)
